<template>
    <div>
        ...
        <el-table style="width: 100%" :data="informations">
            ...
            <el-table-column label="我的留言" align="center" :show-overflow-tooltip="true">
                <template slot-scope="scope">
                    <span style="margin-left: 10px">{{ scope.row.my_message }}</span>
                </template>
            </el-table-column>
            <el-table-column label="我的信息" :show-overflow-tooltip="true" align="center">
                <template slot-scope="scope">
                    <span style="margin-left: 10px">{{ scope.row.my_info }}</span>
                </template>
            </el-table-column>
            <el-table-column label="我的希望" :show-overflow-tooltip="true" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column label="操作" fixed="right" align="center" width="180">
                <template slot-scope="scope">
                    <el-button size="mini" @click="$router.push(`/information/edit/${scope.row.id}`)">编辑</el-button>
